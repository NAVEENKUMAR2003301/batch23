...
// // // TagName Select (getElementByTagName)

// // let Tag = document.getElementsByTagName("h1")

// // console.log(Tag);

// // // ClassName Select (getElementByClassName)

// // let class1 = document.getElementsByClassName("one")

// // console.log(class1);

// // // Id Select (getElementById)
...
// // let className = document.querySelector(".aa")

// // console.log(className);

// // // id

// // let idName = document.querySelector("#bb")
...
//    console.log(parent);
//    console.log(parent.children); // children -- Text
//    console.log(parent.childElementCount); // childElementCount -- number
//    console.log(parent.firstElementChild); // firstElementChild -- 1 child
//    console.log(parent.lastElementChild);  // lastElementChild -- last child
...
//  // input tag only you can use (value)

//  let input = document.querySelector("input")

//      input.value = "hello"

//  // other tag inside value if you manipulate (1.innerText, 2. textContent, 3.innerHTML)
...
//  let two = document.querySelector(".child2")

//      two.textContent = 22

//  let three = document.querySelector(".child3")

//  three.innerHTML = `<h1>23</h1> </br> <p>hello</p>`
...
//   function one(){
//      child4.innerText = "24 hujhjkhjnkjhkk"
//   }
